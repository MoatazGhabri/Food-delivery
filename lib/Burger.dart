...
class Burger extends StatelessWidget {
  ...
  final String? number;
  const Burger({Key? key,this.email, this.name, this.address, this.number}) : super(key: key);
  @override
...
class _AndroidSmall2State extends State<AndroidSmall2> {
  ...
  Future<void> getFoods() async {
    ...
    final foodsReference = databaseReference.child('foods').orderByChild('category').equalTo('Burger');
